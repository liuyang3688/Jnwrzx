...
<!--/左侧导航-->
  ...
  <div class="mainBox">
    <div class="loc clear">
      <div class="position"> <span>您的位置：</span> <a href="<?php echo Yii::app()->homeUrl?>">首页</a> <em></em> <span>蔚然动态</span><em></em><a href="<?php echo $this->createUrl('post/index',array('catalog'=>$catalogArr['id']))?>"><?php echo $catalogArr['catalog_name']?></a>  </div>
    </div>
    <div class="postWrap">
      <div class="h head">
