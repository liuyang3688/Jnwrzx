...
<div class="global clear">
  ...
  <div class="mainBox floatL">
    <div class="loc clear">
      <div class="floatL position"> <span>您的位置：</span> <a href="<?php echo Yii::app()->homeUrl?>">首页</a> <em></em> <a href="<?php echo $this->createUrl('post/index',array('catalog'=>$catalogArr['id']))?>"><?php echo $catalogArr['catalog_name']?></a> <em></em> 查看内容 </div>
    </div>
    <div class="postWrap">
      <div class="h head">
